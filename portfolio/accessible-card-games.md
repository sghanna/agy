...
[Play Hearts](https://sghanna.github.io/agy/hearts/) · [Source and validation](https://github.com/sghanna/agy/tree/main/hearts) · [Solitaire project](https://sghanna.github.io/agy/solitaire/)
...
[Inspect the shading comparison](https://sghanna.github.io/agy/reviews/card-opacity/) · [Compare the red inks](https://sghanna.github.io/agy/reviews/red-ink/)
...
[Replay the six turn cues](https://sghanna.github.io/agy/reviews/turn-cues/)
...
[Compare the received-card approaches](https://sghanna.github.io/agy/reviews/received-cards/)
...
[Compare the six icons](https://sghanna.github.io/agy/reviews/home-icons/)
...
| --- | --- |
| ![Unplayable cards have an even dark overlay while legal cards retain their full color.](./assets/legal-cards.png) | ![The whole hand has blue felt behind it, with Your turn and Choose any card above.](./assets/your-turn.png) |

| Received cards remain identifiable | Scores expose a developing moon attempt |
| --- | --- |
| ![Three newly received cards are bright while the ten original cards are shaded, with a Start playing button.](./assets/received-cards.png) | ![The visible hand scores and moon watch show an opponent collecting penalty points.](./assets/moon-watch.png) |
...
Technical validation during development included 120 seeded complete matches; 162 screen checks across 18 states, three viewport sizes, and three languages; and browser checks for a full hand, saved-game recovery, and offline loading. Animation checks covered interruption, rotation, Reduced Motion, early continuation, and unchanged game state. The selected icon files were checked in WebKit and through the offline cache. [Validation details and scripts](https://github.com/sghanna/agy/tree/main/hearts#development-and-validation).
